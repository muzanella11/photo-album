...
export const FETCH_DETAIL_BY_USER_ID = `${NAMESPACE}_FETCH_DETAIL_BY_USER_ID`
...
export const actionMethod = {
    ...
    [FETCH_DETAIL_BY_USER_ID] (id: any) {
        return new Promise((resolve, reject) => {
            const fetchAll = (async () => {
                try {
                    const albums = await api.albums.list(`userId=${id}`).then(res => res.data)
